...
const quickStartList = [
    ...
    {
        label: 'Create your first Sceduale!',
        desc: 'Building your own sceduale the way that fit your needs',
    ...
    {
        label: 'Trace the changes that occurs on sceduales',
        desc: 'Any changes occur from chairman or admins u will be notified',
        btnText: 'Check notifications',
        id: '2',
        disabled: false
    },
]
